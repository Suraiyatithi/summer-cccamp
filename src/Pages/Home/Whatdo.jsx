...
const Whatdo = () => {
    return (
        <div className='mt-12'>
            <div className="">
                <div className="flex">
                    <div className=" w-full lg:w-3/5 sm:w-full">
          ...
          <p className='text-left'>___________________________________</p>
          <h1 className=' mt-6 text-7xl lg:text-7xl leading-loose  font-semibold '>WE PROVIDE THE <span className='text-rose-900'>BEST INSTRUCTOR</span> </h1>
                ...
                <div className="flex">
                    ...
                    <div className="w-full lg:w-3/4 sm:w-1/1">
                        <div className="grid lg:grid-cols-3 sm:grid-cols-1 mt-3">
                            ...
                            <div className="card border border-rose-900">
